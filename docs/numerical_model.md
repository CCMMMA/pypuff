...
PyPuff v0.4.0 improves the numerical core while keeping the clean-room boundary. The implementation is guided by public CALPUFF-system concepts and component roles, but it does not translate or embed original Fortran source code.

## Feature alignment

The public Version 7 materials describe a non-steady-state transport, dispersion, and deposition model, Version 7 additions for flare, roadway, and aerial spray sources, and newer postprocessors for averages, maxima, ranked values, and percentiles. PyPuff implements independent counterparts at screening fidelity:
...
- CALPOST-style maximum, percentile, nth-rank, running-average, and block-average statistics;
