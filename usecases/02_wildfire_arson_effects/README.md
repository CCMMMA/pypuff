...
3. **Downscale wind.** Reuse use case 01 logic: PyWRF extracts WRF wind and PyMET interpolates it to 100 m.
...
6. **Run dispersion.** Execute PyPuff with the Gaussian or particle backend.
...
- `wildfire_event.json` — the generated PyPuff configuration.
